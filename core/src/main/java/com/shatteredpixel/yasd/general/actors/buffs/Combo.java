...
public class Combo extends Buff implements ActionIndicator.Action {
	...
	public Image getIcon() {
		Image icon;
		if (((Hero)target).belongings.getWeapon() != null){//If the hero has any weapon equipped, use it's image.
			icon = new ItemSprite(((Hero)target).belongings.getWeapon().image, null);
		} else {
