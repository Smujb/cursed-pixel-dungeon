...
public class DesktopPlatformSupport extends PlatformSupport {
    ...
    public void updateDisplaySize() {
        if (!CPDSettings.fullscreen()) {
            CPDSettings.windowResolution( new Point( Game.width, Game.height ) );
        }
    }
    ...
    public void setupFontGenerators(int pageSize, boolean systemfont) {
        ...
        if (systemfont) {
            basicFontGenerator = asianFontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("droid_sans.ttf"));
        } else {
